...
if ($_POST['songTitle'] == '' or $_POST['songArtist'] == '' or $_POST['songAlbum'] == '') 
	{?>
		...
		<div  style="float:left;"><input size="10" required="required" type='text' name='songTitle' maxlength='50' value='' style="color:#444; background-color:#CCC; border:none; padding:5px"></div>
		</td><td style="padding:5px; font-size:12px;">SongArtist(50)<br/>
		<div  style="float:left;"><input size="10" required="required" type='text' name='songArtist' maxlength='50' value='' style="color:#444; background-color:#CCC; border:none; padding:5px"></div>
		</td><td style="padding:5px; font-size:12px;">SongArtistFt(100)<br/>
		<div  style="float:left;"><input size="10" required="required" type='text' name='songArtistFt' maxlength='50' value='' style="color:#444; background-color:#CCC; border:none; padding:5px"></div>
		</td><td style="padding:5px; font-size:12px;">SongAlbum(50)<br/>
		<div  style="float:left;"><input size="10" required="required" type='text' name='songAlbum' maxlength='50' value='' style="color:#444; background-color:#CCC; border:none; padding:5px"></div>
